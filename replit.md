...
- **SEO:** Meta description, OG tags, Twitter Card, canonical URL on all pages (landing, nedir, pricing, analysis, legal, app panel). JSON-LD structured data: Organization+WebSite on landing, FAQPage on pricing. robots.txt + sitemap.xml served via Flask routes. App panel (index.html) has noindex/nofollow.
