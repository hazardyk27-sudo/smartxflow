...
ALARM_CONFIG_FIELDS = {
    'sharp': [
        ('min_sharp_score', 'Min Sharp Skor', 15),
        ('min_volume_1x2', 'Min Hacim 1X2', 3000),
        ('min_volume_ou25', 'Min Hacim O/U', 1000),
        ('min_volume_btts', 'Min Hacim BTTS', 500),
        ('volume_multiplier', 'Hacim Çarpanı', 1.0),
        ('odds_multiplier', 'Oran Çarpanı', 1.0),
        ('share_multiplier', 'Pay Çarpanı', 1.0),
    ],
    'publicmove': [
        ('min_sharp_score', 'Min Skor', 20),
        ('min_volume_1x2', 'Min Hacim 1X2', 5000),
        ('min_volume_ou25', 'Min Hacim O/U', 2000),
        ('min_volume_btts', 'Min Hacim BTTS', 1000),
    ],
    'insider': [
        ('insider_hacim_sok_esigi', 'Hacim Şok Eşiği', 2),
        ('insider_oran_dusus_esigi', 'Oran Düşüş %', 3),
        ('insider_sure_dakika', 'Süre (dk)', 30),
        ('insider_max_para', 'Max Para', 5000),
        ('insider_max_odds_esigi', 'Max Oran Eşiği', 10.0),
    ],
    'bigmoney': [
        ('big_money_limit', 'Big Money Limiti (£)', 15000),
    ],
    'dropping': [
        ('min_drop_l1', 'L1 Min %', 7),
        ('max_drop_l1', 'L1 Max %', 10),
        ('min_drop_l2', 'L2 Min %', 10),
        ('max_drop_l2', 'L2 Max %', 15),
        ('min_drop_l3', 'L3 Min %', 15),
    ],
    'volumeshock': [
        ('volume_shock_multiplier', 'Şok Çarpanı', 3.0),
        ('min_hours_to_kickoff', 'Min Saat', 2),
    ],
    'volumeleader': [
