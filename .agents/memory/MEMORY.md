...
- [Hetzner SSH access](hetzner-ssh-access.md) — HETZNER_IP + HETZNER_PASSWORD secrets mevcut; sshpass ile bağlanılır; repo /root/smartxflow; git pull + servis restart yapılabilir.
