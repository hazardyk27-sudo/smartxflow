...
echo ""
echo "============================================"
echo " SSL Sertifikası (HTTPS)"
echo "============================================"
echo " 1. Domain yönetim panelinizden DNS A kaydı ekleyin:"
echo "    Tip: A   Ad: @    Değer: 91.99.6.245"
echo "    Tip: A   Ad: www  Değer: 91.99.6.245"
echo ""
echo " 2. DNS çözümlenince ($DOMAIN → 91.99.6.245):"
echo "    sudo bash $APP_DIR/deploy/setup_ssl.sh"
echo ""
echo "    Script otomatik olarak:"
echo "    - DNS kaydını doğrular"
echo "    - certbot --nginx ile Let's Encrypt sertifikası alır"
echo "    - HTTP → HTTPS yönlendirmeyi aktif eder"
echo ""
echo "============================================"
