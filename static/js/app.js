...
currentDayFilter=filter;var labels={all:'Tümü',today:'Bugün',yesterday:'Dün'};var labelEl=document.getElementById('dayFilterLabel');if(labelEl)labelEl.textContent=labels[filter]||'Tümü';document.querySelectorAll('.day-filter-option').forEach(function(opt){opt.classList.toggle('active',opt.getAttribute('data-value')===filter);});const todayBtn=document.getElementById('todayBtn');const yesterdayBtn=document.getElementById('yesterdayBtn');if(filter==='today'){if(todayBtn&&!todayBtn.classList.contains('active')){toggleTodayFilter(true);}
if(yesterdayBtn&&yesterdayBtn.classList.contains('active')){toggleYesterdayFilter(true);}}else if(filter==='yesterday'){if(yesterdayBtn&&!yesterdayBtn.classList.contains('active')){toggleYesterdayFilter(true);}
if(todayBtn&&todayBtn.classList.contains('active')){toggleTodayFilter(true);}}else{if(todayBtn&&todayBtn.classList.contains('active')){toggleTodayFilter(true);}
